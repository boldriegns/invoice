...
$(document).ready(function() {
	...
	function calculateTotal() {
	    ...
	    $('#invoice_table tbody tr').each(function() {
            var c_sbt = $('.calculate-sub', this).val(),
	            ...
	            price = $('[name="invoice_[]"]', this).val() || 0,
                subtotal = parseInt(quantity) * parseFloat(price);
		...
		if (errorCounter > 0) {
			...
			$.ajax({
				...
				error: function(xhr, status, error) {
					var errorMessage = "Could not add user";
	...
	function actionMakeOrder() {
		...
		if (errorCounter > 0) {
			...
			var $btn = $("#actionMakeOrder").button("loading");
			...
			$.ajax({
				...
				success: function(data){
					...
					$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
					$btn.button("reset");
					window.location = "orders_list.php";
				},
				error: function(xhr, status, error) {
					var errorMessage = "Could not add to the order";
					$("#response .message").html("<strong>Error</strong>: " + errorMessage);
					$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
					$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
					$btn.button("reset");
	...
	function actionCreateCustomer(){
		...
		if (errorCounter > 0) {
			...
			$.ajax({
				...
				error: function(xhr, status, error) {
					var errorMessage = "Could not create customer";
					$("#response .message").html("<strong>Error</strong>: " + errorMessage);
					$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
					$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
					$btn.button("reset");
	...
	function actionCreateInvoice(){
		...
		if (errorCounter > 0) {
			...
			$.ajax({
				...
				error: function(xhr, status, error) {
					var errorMessage = "Could not create the invoice";
					$("#response .message").html("<strong>Error</strong>: " + errorMessage);
					$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
					$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
					$btn.button("reset");
   	...
   	function deleteProduct(productId) {
        ...
        jQuery.ajax({
            ...
            success: function(data){
				...
				error: function(xhr, status, error) {
				var errorMessage = "Could not delete the product";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function deleteUser(userId) {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not delete the user";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
	...
	function deleteCustomer(userId) {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not delete customer details";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function emailInvoice(invoiceId) {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not email the invoice";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function deleteInvoice(invoiceId) {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not delete the invoice";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function updateUser() {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not update user details";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function updateCustomer() {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not customer details";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
   	...
   	function updateInvoice() {
        ...
        jQuery.ajax({
			...
			error: function(xhr, status, error) {
				var errorMessage = "Could not update invoice details";
				$("#response .message").html("<strong>Error</strong>: " + errorMessage);
				$("#response").removeClass("alert-success").addClass("alert-warning").fadeIn();
				$("html, body").animate({ scrollTop: $('#response').offset().top }, 1000);
				$btn.button("reset");
