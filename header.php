  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-user"></i><span>View</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="product-list.php"><i class="fa fa-eye"></i>View products</a></li>
            <li><a href="orders_list.php"><i class="fa fa-eye"></i>orders placed</a></li>
            <li><a href="invoice-list.php"><i class="fa fa-eye"></i>View invoice</a></li>
          </ul>
        </li>
        <?php endif; ?>
        <!-- Menu 1 -->
        <?php if($_SESSION['user_role'] == 'admin' || $_SESSION['user_role'] == 'vendor'): ?>
         <li class="treeview">
        ...
        <!-- Menu 2 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="orders_list.php"><i class="fa fa-eye"></i>View customer orders</a></li>
          </ul>
        </li>
                <!-- Menu 2 -->
                <li class="treeview">
          <a href="#"><i class="glyphicon glyphicon-stats"></i><span>reports</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li><a href="report.php"><i class="fa fa-cog"></i>Generate report</a></li>
            <li><a href="download.php"><i class="fa fa-download"></i> download report</a></li>
          </ul>
        </li>
        <!-- Menu 3 -->
        <li class="treeview">
