            ...
            <div class="panel-body form-group form-group-sm">
                <form method="post" id="add_user">
                    ...
                    <div class="row">
						...
						<div class="col-xs-4">
                            <input type="text" class="form-control margin-bottom required" name="customer_county" placeholder="Enter user's county">
                        </div>
                        <div class="col-xs-4">
                            <input type="text" class="form-control" name="customer_address_1" placeholder="Enter user's address">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                            <input type="text" class="form-control margin-bottom required" name="customer_town" placeholder="Enter user's town">
                        </div>
                        <div class="col-xs-4">
